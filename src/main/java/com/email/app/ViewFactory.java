...
public class ViewFactory {
    ...
    public static ArrayList<Stage> activeStages; // Keeps record of active stages which would help in updating css
    ...
    private String tableStyle = TableStyle.getCssPath();
    ...
    public void showDetailsWindow(){
        System.out.println("Optional");
        BaseController controller = new OptionsWindowController(emailManager, this, "viewDetails.fxml");
        initializeStage(controller);
    }
    ...
    public void updateStyles() {
            for (Stage stage: activeStages) {
                ...
                scene.getStylesheets().add(getClass().getResource(tableStyle).toExternalForm()); // for font files
            }
    }
}
